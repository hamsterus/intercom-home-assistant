...
class IntercomCardV3 extends HTMLElement{
 ...
 async loadUI(){if(window.IntercomCardUIV3)return;const s=document.createElement("script");s.src="/local/intercom.v3/intercom-card-ui.js?v=3";s.onload=()=>{this.render();this.update()};s.onerror=e=>console.error("[IntercomCardV3] UI load error",e);document.head.appendChild(s)}
