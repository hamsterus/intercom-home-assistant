/* Intercom Card v3.0 — isolated controller. */
class IntercomCardV3 extends HTMLElement{
 ...
 async loadUI(){if(window.IntercomCardUIV3)return;const s=document.createElement("script");s.src="/local/intercom.v3/intercom-card-ui-v3.js?v=3";s.onload=()=>{this.render();this.update()};s.onerror=e=>console.error("[IntercomCardV3] UI load error",e);document.head.appendChild(s)}
